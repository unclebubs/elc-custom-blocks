...
class PodcastNoAllYearNavigationTest extends WP_UnitTestCase
{
  ...
  public function test_all_pocasts_are_listed()
  {
    ...
    $this->assertEquals(1, $count, 'The string "nav-item" should occur once');
    $this->assertStringContainsStringIgnoringCase('data-year="2024"', $output, 'The output should should contain the year 2024');
    $this->assertFalse(strpos($output, 'data-year="all"'), $output, 'The output should should not contain the year All Years');
  }
}
